...
class Bananamilk extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Column(
          ...
          children: <Widget> [
            Center(
              child:CircleAvatar(
                // ctrl+ space 속성확인
                backgroundImage: AssetImage('assets/bananamilk.jpg'),
            ...
            InkWell(child:Text('오디맛은 오디에?',
              ...
              onTap: () {
                print("오디맛은 오디에");
                Navigator.pushNamed(context, '/odimilk');
              },),
            // SizedBox(
            //   height:30.0,
            // ),
